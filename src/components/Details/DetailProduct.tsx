...
const DetailProduct = () => {
  return (
    <div className='px-5 py-8 text-black lg:py-24 lg:pt-40 lg:px-24'>
      <div className='rounded-lg ring-2 ring-gray-300 p-7'>
        <div className="max-w-screen-xl px-4 mx-auto lg:px-0">
          <div className="lg:grid lg:grid-cols-2 lg:gap-8 xl:gap-16">
            <div className="max-w-md mx-auto shrink-0 lg:max-w-lg">
              <img className="hidden w-full dark:block" src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/imac-front-dark.svg" alt="" />
            </div>
